                            ...
                            @foreach ($suppliers as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('supplier.delete', $item->id) }}" class="btn btn-danger" id="delete">
