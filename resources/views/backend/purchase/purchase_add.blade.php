                        ...
                        <div class="col-md-4">
                            <div class="md-3">
                                ...
                                <input class="form-control example-date-input" name="purchase_no"
                                    value="{{ rand(999, 999999) }}" type="text" disabled id="purchase_no">
                            </div>
                        </div>
...
@section('js')
    ...
    <script id="document-template" type="text/x-handlebars-template"><tr class="delete_add_more_item" id="delete_add_more_item">
