                        ...
                        <tbody>
                            @foreach ($customers as $key => $item)
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    <td>{{ $item->name }}</td>
                                    <td><img src="{{ $item->customer_image != '' ? asset('upload/customer/' . $item->customer_image) : asset('upload/no_img.jpg') }}"
